<div id="container">
	...
	<div id="back" onclick="back();">
		<img src="<?php echo Yii::app()->baseUrl; ?>/images/back arrow.png" />
	</div>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		$("#container").attr("style","position:absolute; background-size:100% 100%; background-repeat:no-repeat; background-image:url('<?php echo Yii::app()->baseUrl."/images/background/".$template->background_link; ?>'); width:100%; height:100%;");
		...
		$("#back").attr("style","position:absolute; top: <?php echo $template->back_y; ?>px; left: <?php echo $template->back_x; ?>px;");
	});
	function back()
	{
		start2(<?php echo $template->icon_y; ?>);
		setTimeout(function(){
